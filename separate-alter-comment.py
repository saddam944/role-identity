...
def comments_writing_to_files():
    ego="PrinceTaufiqul" #put ego name here
    ...
    for key,val in userfrequency.items():
        ...
        if val==1:
            ...
            for k in fnames:
                ...
                if key==k:
                    try:
                        file = open("E:/PrinceTaufiqul-comments/"+key+"-"+ego+"_.txt","w") 
                        #print key
                        #print indx
                        #print frnd_comments[indx-1]
                        file.write(fcomments[indx-1])
                        file.close()
                    except:
                        continue
